...
if ($_SESSION['data']['email'] != null && $_SESSION['data']['login'] == true) {
    ...
    if (isset($_REQUEST['delete_id'])) {
        $qry = "DELETE FROM `slidertable` where id = :id";
        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modern">
                <header class="page-header page-header-left-inline-breadcrumb">
                    <h2 class="font-weight-bold text-6">Slider</h2>
                                    ...
                                    <div class="datatable-header">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                                <a href="/ecoomercex/admin/sliderCreate.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Slider</a>
                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $createAt = strtotime($item['create_at']);
                                                        echo date("d-M-Y", $createAt);
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <a href="./editSlide.php?slider_id=<?= $item['id']; ?>" class="btn btn-primary">Edit</a>
                                                        <a href="./SliderIndex.php?delete_id=<?= $item['id']; ?>" class="btn btn-danger" onclick="return checkDelete()">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
