                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <ul class="header-top-menu">
                            <li><a href="dashboard.php"><i class='bx bxs-user'></i> My Account</a></li>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item megamenu"><a href="#" class="nav-link">Shop</a></li>
                                        ...
                                        <li class="nav-item">
                                            <div class="container">
                                                <div class="row justify-content-center">
                                                    <div class="col">
                                                        <h6 class="submenu-title">Tops</h6>
                                                    ...
                                                    <div class="col">
                                                        <h6 class="submenu-title">Derss</h6>
                                                    ...
                                                    <div class="col">
                                                        <h6 class="submenu-title">Shose</h6>
